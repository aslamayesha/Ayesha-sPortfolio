export default function FirstSection({ title, description }: { title: string; description: string }) {
  ...
  return (
    <section className="w-[91%] mx-auto md:px-8 px-0">
      <div className="flex  justify-between">
        <div className="mt-13 ">
          <div className="relative text-left flex flex-col md:items-start items-center ">
            ...
            <svg
              ...
              className="absolute md:-bottom-[-5px] -bottom-[5px] md:left-2 left-14 animate-slide-in-left animate-delay-1 w-3/4 md:w-[500px]"
            >
              <path
        ...
        <div
        className="hidden md:block leading-[1] uppercase mb-3 px-4 md:px-10 lg:px-0 flex items-end  md:opacity-70 lg:opacity-70 sm:opacity-10 md:text-[288px] text-[165px] md:font-medium font-light whitespace-nowrap text-transparent [-webkit-text-stroke:1px_#ffffff]"
        style={{ fontFamily: "Anton, sans-serif" }}
      >
        {title === "projects" ? (
          <>
