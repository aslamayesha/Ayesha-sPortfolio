  ...
  return (
    <div>
      <div className="flex justify-between pr-3">
        <div className="ml-27 mt-13 w-xl  ">
          <div className="relative text-left flex flex-col items-start ">
            <h1
              className="relative text-[50px] sm:text-[80px] lg:text-[100px] xl:text-[144px] text-center text-[#6f64f3] font-bold uppercase  animate-fade-in"
            ...
            <svg
              ...
              className="absolute -bottom-[-10px] left-2 animate-slide-in-left animate-delay-1 "
            >
              <path
          ...
          <div className="flex flex-col gap-28 w-3xl">
          <div className="flex  h-[90px] items-center justify-between mt-20 w-[600px]">
            <button className="bg-white cursor-pointer text-[#6c63ff]  font-bold py-[15px] px-[30px] rounded-full shadow hover:bg-[#6c63ff] hover:text-white transition-all duration-300 text-base animate-scale-in animate-delay-2 hover-lift hover-glow animate-pulse-slow group relative overflow-hidden">
            ...
            <p className="text-white text-[17px] w-[356px] font-sans font-light">
              {description}
            </p>
          </div>

          <div className=" border border-[#62606F]"/>
          </div>
        </div>

        <div
        className="leading-[1] uppercase mb-3 px-4 md:px-10 lg:px-23 flex items-end  md:opacity-70 lg:opacity-70 sm:opacity-10 md:text-[288px] text-[165px] md:font-medium font-light whitespace-nowrap text-transparent [-webkit-text-stroke:1px_#ffffff]"
        style={{ fontFamily: "Anton, sans-serif" }}
      >
        {title === "projects" ? (
          <>
