    ...
    <section className=" w-full h-full sm:h-[110vh] flex items-center bg-[#020015]">
      <div className="container px-4 md:px-0 lg:px-8 mx-auto min-h-[60vh] flex flex-col xl:flex-row items-center xl:items-start justify-center md:justify-between gap-8 md:gap-0">
        ...
        <div className="flex-1 flex flex-col items-center md:items-end justify-center md:justify-start mt-8 md:mt-0 order-1 xl:order-2">
          ...
          <p
            className="text-white font-sans text-[13px] sm:text-[20px] lg:text-[20px] xl:text-[16px]  font-light ml-0  text-center md:text-right mt-6 max-w-xs animate-slide-in-right animate-delay-3 px-4 md:px-0 md:mr-8 lg:w-[170px]"
        ...
        <div className="flex-1 flex flex-col items-center xl:items-start justify-center max-w-2xl text-center md:text-left order-2 md:order-1">
          <h1
            className="text-[50px] sm:text-[80px] lg:text-[100px] xl:text-[144px] w-[100%] text-center xl:text-left xl:w-[138%] leading-[1.1] text-[#6f64f3] font-extrabold uppercase mb-4 animate-fade-in"
          ...
          <svg
            ...
            className="animate-slide-in-left animate-delay-1 w-[100%] xl:w-[130%]  md:max-w-none"
          >
            <path
          ...
          <button onClick={handleGmailClick} className="bg-white cursor-pointer text-[#6c63ff] mt-6 md:mt-10 font-bold py-[15px] px-[30px] rounded-full shadow hover:bg-[#6c63ff] hover:text-white transition-all duration-300 text-base animate-scale-in animate-delay-2 hover-lift hover-glow animate-pulse-slow group relative overflow-hidden">
