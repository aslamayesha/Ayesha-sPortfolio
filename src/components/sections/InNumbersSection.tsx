    ...
    <section id="in-numbers" className="bg-[#0a0a0a] w-full h-full flex items-center">
      <div className="container mx-auto px-8">
        <div className="border-t border-gray-700 pt-16">
          ...
          <h2
            className=" font-anton text-[60px] text-[#62606F] leading-tight uppercase font-medium mb-6 animate-fade-in"
            style={{ fontFamily: 'Anton, sans-serif' }}
          >
            In Numbers
          </h2>
          <p className="text-white  text-left max-w-2xl mb-12 animate-fade-in animate-delay-1 font-sans text-[17px] font-light">
          ...
          <div className="flex gap-8 float-right mt-[10px] ">
